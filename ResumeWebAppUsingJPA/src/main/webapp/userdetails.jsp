        ...
        <div class="container">
            <form action="userdetails" method="post">
                ...
                <div>
                    ...
                    <input type="text" class="form-control" name="email" value="<%=user.getCountryByCountryId().getName()%>"/>
                </div>
                <div>
                    <label>Nationality: </label>
                    <input type="text" class="form-control" name="birthday" value="<%=user.getCountryByCountryId().getNationality()%>" style="margin-bottom: 10px"/>
                </div>
